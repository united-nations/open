...
//
// `code` matches the mission or entity code in the active
// public/data/budget-audited-{pko,ppb}-{year}.json files.
...
export interface MissionLocation {
  /** Mission or entity code, as in the audited budget JSON files */
  code: string;
  /** Official name */
  name: string;
  kind: MissionKind;
